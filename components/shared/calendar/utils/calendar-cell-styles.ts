...
export const getButtonClassName = (
  ...
  return cn(
    ...
    isHovered &&
      isXl &&
      "xl:!absolute xl:!top-0 xl:!left-0 xl:!right-0 xl:!min-h-[209px] 2xl:!min-h-[314px] xl:!max-h-[340px] 2xl:!max-h-[560px]",
    isHovered && isXl
      ? "bg-main text-white"
      : dayEvents.length === 0
...
export const getEventsContainerClassName = (
  ...
  return cn(
    ...
    isXl
      ? isHovered
        ? "flex-1 min-h-0 overflow-y-auto calendar-cell-scroll -mx-4 px-4 -mt-6 pt-6 -mb-4 pb-4 2xl:-mx-6 2xl:px-6 2xl:-mt-10 2xl:pt-10 2xl:-mb-6 2xl:pb-6"
        : "flex-1 min-h-0"
      : "hidden",
    !isCurrentMonth && "opacity-50",
  );
...
export const getEventsContainerStyles = (
  ...
  width: isXl && isHovered ? undefined : "100%",
